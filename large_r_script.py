...
summary_1 = sales_data.groupby('flag_1').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_1', 'mean')
).reset_index()
...
summary_2 = sales_data.groupby('flag_2').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_2', 'mean')
).reset_index()
...
summary_3 = sales_data.groupby('flag_3').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_3', 'mean')
).reset_index()
...
summary_4 = sales_data.groupby('flag_4').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_4', 'mean')
).reset_index()
...
summary_5 = sales_data.groupby('flag_5').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_5', 'mean')
).reset_index()
...
summary_6 = sales_data.groupby('flag_6').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_6', 'mean')
).reset_index()
...
summary_7 = sales_data.groupby('flag_7').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_7', 'mean')
).reset_index()
...
summary_8 = sales_data.groupby('flag_8').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_8', 'mean')
).reset_index()
...
summary_9 = sales_data.groupby('flag_9').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_9', 'mean')
).reset_index()
...
summary_10 = sales_data.groupby('flag_10').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_10', 'mean')
).reset_index()
...
summary_11 = sales_data.groupby('flag_11').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_11', 'mean')
).reset_index()
...
summary_12 = sales_data.groupby('flag_12').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_12', 'mean')
).reset_index()
...
summary_13 = sales_data.groupby('flag_13').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_13', 'mean')
).reset_index()
...
summary_14 = sales_data.groupby('flag_14').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_14', 'mean')
).reset_index()
...
summary_15 = sales_data.groupby('flag_15').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_15', 'mean')
).reset_index()
...
summary_16 = sales_data.groupby('flag_16').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_16', 'mean')
).reset_index()
...
summary_17 = sales_data.groupby('flag_17').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_17', 'mean')
).reset_index()
...
summary_18 = sales_data.groupby('flag_18').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_18', 'mean')
).reset_index()
...
summary_19 = sales_data.groupby('flag_19').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_19', 'mean')
).reset_index()
...
sales_data['flag_20'] = (sales_data['id'] % 21 == 0).astype(int)

sales_data['adj_sales_20'] = sales_data['sales_amount'] * 20 * 0.05

summary_20 = sales_data.groupby('flag_20').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_20', 'mean')
).reset_index()
...
sales_data['flag_21'] = (sales_data['id'] % 22 == 0).astype(int)

sales_data['adj_sales_21'] = sales_data['sales_amount'] * 21 * 0.05

summary_21 = sales_data.groupby('flag_21').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_21', 'mean')
).reset_index()
...
sales_data['flag_22'] = (sales_data['id'] % 23 == 0).astype(int)

sales_data['adj_sales_22'] = sales_data['sales_amount'] * 22 * 0.05

summary_22 = sales_data.groupby('flag_22').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_22', 'mean')
).reset_index()
...
sales_data['flag_23'] = (sales_data['id'] % 24 == 0).astype(int)

sales_data['adj_sales_23'] = sales_data['sales_amount'] * 23 * 0.05

summary_23 = sales_data.groupby('flag_23').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_23', 'mean')
).reset_index()
...
sales_data['flag_24'] = (sales_data['id'] % 25 == 0).astype(int)

sales_data['adj_sales_24'] = sales_data['sales_amount'] * 24 * 0.05

summary_24 = sales_data.groupby('flag_24').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_24', 'mean')
).reset_index()
...
sales_data['flag_25'] = (sales_data['id'] % 26 == 0).astype(int)

sales_data['adj_sales_25'] = sales_data['sales_amount'] * 25 * 0.05

summary_25 = sales_data.groupby('flag_25').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_25', 'mean')
).reset_index()
...
sales_data['flag_26'] = (sales_data['id'] % 27 == 0).astype(int)

sales_data['adj_sales_26'] = sales_data['sales_amount'] * 26 * 0.05

summary_26 = sales_data.groupby('flag_26').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_26', 'mean')
).reset_index()
...
sales_data['flag_27'] = (sales_data['id'] % 28 == 0).astype(int)

sales_data['adj_sales_27'] = sales_data['sales_amount'] * 27 * 0.05

summary_27 = sales_data.groupby('flag_27').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_27', 'mean')
).reset_index()
...
sales_data['flag_28'] = (sales_data['id'] % 29 == 0).astype(int)

sales_data['adj_sales_28'] = sales_data['sales_amount'] * 28 * 0.05

summary_28 = sales_data.groupby('flag_28').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_28', 'mean')
).reset_index()
...
sales_data['flag_29'] = (sales_data['id'] % 30 == 0).astype(int)

sales_data['adj_sales_29'] = sales_data['sales_amount'] * 29 * 0.05

summary_29 = sales_data.groupby('flag_29').agg(
    count=('id', 'size'),
    avg_sales=('adj_sales_29', 'mean')
).reset_index()
...
sales_data['flag_30'] = (sales_data['id'] % 31 == 0).astype(int)
...
sales_data['flag_31'] = (sales_data['id'] % 32 == 0).astype(int)
...
sales_data['flag_32'] = (sales_data['id'] % 33 == 0).astype(int)
...
sales_data['flag_33'] = (sales_data['id'] % 34 == 0).astype(int)
...
sales_data['flag_34'] = (sales_data['id'] % 35 == 0).astype(int)
...
sales_data['flag_35'] = (sales_data['id'] % 36 == 0).astype(int)

sales_data['adj_sales_35'] = sales_data['sales_amount'] * 35 *